...
| JOIN 방향별 실측: StarRocks가 inner일 때 MySQL이 inner일 때보다 15배 이상 느림 | 📊 | [`05`](examples/05_join_direction_benchmark.sh), [수치](docs/FINDINGS.md#join-방향별-성능-실측-네이티브-amd64-2026-08-29) |
